# One Notification Promo


One Notification Promo is a [Tailwind UI](https://tailwindui.com) site template built using [Tailwind CSS](https://tailwindcss.com) and [Next.js](https://nextjs.org), with a blog powered by [Sanity](https://www.sanity.io).
...
Next, create a new Sanity project to power the blog:

```bash
npm create sanity@latest -- --env=.env.local --create-project "One Notification Promo Blog" --dataset production
```
